...
ARGS=(LOCALVERSION=lto LLVM=1 LLVM_IAS=1 DTC_EXT="$(pwd)/tools/dtc" CONFIG_BUILD_ARM64_DT_OVERLAY=y ARCH=arm64 CROSS_COMPILE="$HOME/tool/GCC/bin/aarch64-linux-android-" REAL_CC="ccache clang" CLANG_TRIPLE=aarch64-linux-gnu-)
